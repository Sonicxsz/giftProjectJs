...
/* harmony import */ var _modules_phoneInput__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/phoneInput */ "./src/js/modules/phoneInput.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', '', '', 'horiz');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', '.main-prev-btn', '.main-next-btn');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(stateValue);
  Object(_modules_phoneInput__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_showMoreStyle__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', stateValue);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function burger(burgSelector, menuSelector) {
  var burger = document.querySelector(burgSelector),
...
function drop() {
  ...
  fileInputs.forEach(function (inp) {
    inp.addEventListener('drop', function (e) {
      ...
      var dots;
      var arr = inp.files[0].name.split('.');
...
var filter = function filter() {
  ...
  btnGranMother.addEventListener('click', function () {
    typeFilter();
  });
...
/* harmony import */ var _service_server__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../service/server */ "./src/js/service/server.js");
...
function forms(state) {
  ...
  upload.forEach(function (i) {
    i.addEventListener('input', function () {
      var dots;
      var arr = i.files[0].name.split('.');
      arr[0].length > 6 ? dots = '...' : dots = '.';
      var name = arr[0].substring(0, 6) + dots + arr[1];
  ...
  form.forEach(function (i) {
    i.addEventListener('submit', function (e) {
      ...
      Object(_service_server__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (data) {
        console.log(data);
...
function phoneInput(selector) {
  var phoneInput = document.querySelectorAll(selector);
  ...
  function onPhoneInput(e) {
    ...
    if (['7', '8', '9'].includes(inputNumbersValue[0])) {
      ...
      var firstSybmols = inputNumbersValue[0] == '8' ? '8' : '+7';
      ...
      //not Russian
      formattedInputValue = "+".concat(inputNumbersValue.substring(0, 16));
    }
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _service_server__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/server */ "./src/js/service/server.js");
...
function showMoreStyles(selector) {
  ...
  btn.addEventListener('click', function () {
    Object(_service_server__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles').then(function (data) {
      createCard(data);
    });
    this.remove();
  });
